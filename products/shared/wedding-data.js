...
var WEDDING_DATA = {
    ...
    elements: {
        ...
        items: [
            ...
            /* ---- NAVY / PEARL SET (harvest ziuwedding: navy, ngọc trai, vỏ sò, song hỷ) ---- */
            { id: 'seal-song-hy-gold', file: 'navy-elements/seal-song-hy-gold.webp', name: 'Con dấu sáp Song Hỷ vàng', tags: ['seal', 'gold', 'song-hy', 'traditional', 'envelope'], usage: ['envelope-seal'] },
            { id: 'icon-tap-hand', file: 'navy-elements/icon-tap-hand.webp', name: 'Icon bàn tay chạm', tags: ['icon', 'hint', 'white'], usage: ['tap-hint'] },
            { id: 'pearl-necklace-double', file: 'navy-elements/pearl-necklace-double.webp', name: 'Chuỗi ngọc trai đôi', tags: ['pearl', 'white', 'luxury', 'strand'], usage: ['decor-hanging'] },
            { id: 'pearl-strand-flower-1', file: 'navy-elements/pearl-strand-flower-1.webp', name: 'Dây ngọc trai + hoa trắng 1', tags: ['pearl', 'flower', 'white', 'strand'], usage: ['envelope-decor', 'corner'] },
            { id: 'pearl-strand-flower-2', file: 'navy-elements/pearl-strand-flower-2.webp', name: 'Dây ngọc trai + hoa trắng 2', tags: ['pearl', 'flower', 'white', 'strand'], usage: ['envelope-decor', 'corner'] },
            { id: 'envelope-lightblue', file: 'navy-elements/envelope-lightblue.webp', name: 'Phong bì xanh nhạt', tags: ['envelope', 'blue', 'light'], usage: ['envelope'] },
            { id: 'texture-silk-cream', file: 'navy-elements/texture-silk-cream.webp', name: 'Vân lụa kem', tags: ['texture', 'silk', 'cream', 'luxury'], usage: ['background'] },
            { id: 'envelope-navy', file: 'navy-elements/envelope-navy.webp', name: 'Phong bì xanh navy', tags: ['envelope', 'navy', 'blue', 'luxury'], usage: ['envelope'] },
            { id: 'paper-white-card', file: 'navy-elements/paper-white-card.webp', name: 'Thiệp giấy trắng', tags: ['paper', 'white', 'card'], usage: ['card-background'] },
            { id: 'icon-map-pin', file: 'navy-elements/icon-map-pin.webp', name: 'Icon ghim bản đồ', tags: ['icon', 'map', 'location'], usage: ['map-section'] },
            { id: 'heart-script-white', file: 'navy-elements/heart-script-white.webp', name: 'Trái tim nét chữ trắng', tags: ['heart', 'white', 'script', 'lineart'], usage: ['between-names', 'divider'] },
            { id: 'heart-script-navy', file: 'navy-elements/heart-script-navy.webp', name: 'Trái tim nét chữ navy', tags: ['heart', 'navy', 'script', 'lineart'], usage: ['between-names', 'divider'] },
            { id: 'giftbox-pink', file: 'navy-elements/giftbox-pink.webp', name: 'Hộp quà hồng', tags: ['gift', 'pink', 'box'], usage: ['gift-section'] },
            { id: 'rings-gold', file: 'navy-elements/rings-gold.webp', name: 'Nhẫn cưới vàng', tags: ['icon', 'rings', 'gold', 'lineart'], usage: ['timeline', 'ceremony'] },
            { id: 'rings-navy', file: 'navy-elements/rings-navy.webp', name: 'Nhẫn cưới navy', tags: ['icon', 'rings', 'navy', 'lineart'], usage: ['timeline', 'ceremony'] },
            { id: 'icon-camera-gold', file: 'navy-elements/icon-camera-gold.webp', name: 'Icon máy ảnh vàng', tags: ['icon', 'camera', 'gold', 'lineart'], usage: ['timeline', 'gallery'] },
            { id: 'icon-camera-navy', file: 'navy-elements/icon-camera-navy.webp', name: 'Icon máy ảnh navy', tags: ['icon', 'camera', 'navy', 'lineart'], usage: ['timeline', 'gallery'] },
            { id: 'icon-toast-gold', file: 'navy-elements/icon-toast-gold.webp', name: 'Icon ly cụng vàng', tags: ['icon', 'toast', 'gold', 'lineart'], usage: ['timeline', 'party'] },
            { id: 'icon-toast-navy', file: 'navy-elements/icon-toast-navy.webp', name: 'Icon ly cụng navy', tags: ['icon', 'toast', 'navy', 'lineart'], usage: ['timeline', 'party'] },
            { id: 'heart-red-outline', file: 'navy-elements/heart-red-outline.webp', name: 'Trái tim viền đỏ', tags: ['heart', 'red', 'outline'], usage: ['accent'] },
            { id: 'branch-magnolia-white', file: 'navy-elements/branch-magnolia-white.webp', name: 'Cành mộc lan trắng', tags: ['floral', 'white', 'branch', 'magnolia'], usage: ['background', 'corner'] },
            { id: 'filmstrip-navy', file: 'navy-elements/filmstrip-navy.webp', name: 'Dải phim navy', tags: ['filmstrip', 'navy', 'gallery'], usage: ['gallery-strip'] },
            { id: 'lineart-camera-white', file: 'navy-elements/lineart-camera-white.webp', name: 'Máy ảnh line art trắng', tags: ['icon', 'camera', 'white', 'lineart'], usage: ['gallery'] },
            { id: 'lineart-dining-white', file: 'navy-elements/lineart-dining-white.webp', name: 'Bộ đồ ăn line art trắng', tags: ['icon', 'dining', 'white', 'lineart'], usage: ['party', 'timeline'] },
            { id: 'lineart-bouquet-white', file: 'navy-elements/lineart-bouquet-white.webp', name: 'Bó hoa line art trắng', tags: ['floral', 'white', 'lineart', 'bouquet'], usage: ['decor'] },
            { id: 'shell-starfish-blue', file: 'navy-elements/shell-starfish-blue.webp', name: 'Vỏ sò + sao biển xanh', tags: ['shell', 'starfish', 'blue', 'beach'], usage: ['decor', 'corner'] },
            { id: 'vinyl-tonearm', file: 'navy-elements/vinyl-tonearm.webp', name: 'Cần đĩa than', tags: ['music', 'vinyl', 'retro'], usage: ['music-player'] },
            { id: 'flower-pearl-cluster', file: 'navy-elements/flower-pearl-cluster.webp', name: 'Cụm hoa trắng + ngọc trai', tags: ['flower', 'pearl', 'white', 'cluster'], usage: ['envelope-decor', 'corner'] },
            { id: 'shell-coral-blue', file: 'navy-elements/shell-coral-blue.webp', name: 'Vỏ sò + san hô xanh', tags: ['shell', 'coral', 'blue', 'beach'], usage: ['decor', 'corner'] },
            { id: 'paper-emboss-floral', file: 'navy-elements/paper-emboss-floral.webp', name: 'Giấy dập nổi hoa trắng', tags: ['paper', 'white', 'emboss', 'floral', 'texture'], usage: ['background'] },
            { id: 'pearl-strand-drape', file: 'navy-elements/pearl-strand-drape.webp', name: 'Dây ngọc trai rủ', tags: ['pearl', 'white', 'strand', 'drape'], usage: ['decor-hanging'] },
            { id: 'vinyl-record', file: 'navy-elements/vinyl-record.webp', name: 'Đĩa than', tags: ['music', 'vinyl', 'retro'], usage: ['music-player'] },
            { id: 'divider-ornament-navy', file: 'navy-elements/divider-ornament-navy.webp', name: 'Đường phân cách hoa văn navy', tags: ['divider', 'navy', 'ornament'], usage: ['section-divider'] },
            { id: 'paper-deckle-white', file: 'navy-elements/paper-deckle-white.webp', name: 'Giấy xé mép trắng', tags: ['paper', 'white', 'deckle', 'texture'], usage: ['card-background'] },
            { id: 'wash-watercolor-blue', file: 'navy-elements/wash-watercolor-blue.webp', name: 'Loang màu nước xanh', tags: ['watercolor', 'blue', 'wash', 'texture'], usage: ['background'] },
            { id: 'paper-white-plain', file: 'navy-elements/paper-white-plain.webp', name: 'Giấy trắng trơn', tags: ['paper', 'white', 'texture'], usage: ['card-background'] },
            { id: 'engraving-sea-blue', file: 'navy-elements/engraving-sea-blue.webp', name: 'Khắc hoạ biển mây xanh', tags: ['engraving', 'blue', 'sea', 'vintage'], usage: ['background', 'decor'] },
            { id: 'text-thankyou-white', file: 'navy-elements/text-thankyou-white.webp', name: 'Chữ Thank you trắng', tags: ['typography', 'white', 'script', 'thankyou'], usage: ['closing'] },
            { id: 'divider-rings-faint', file: 'navy-elements/divider-rings-faint.webp', name: 'Phân cách nhẫn mờ', tags: ['divider', 'faint', 'rings'], usage: ['section-divider'] },
            { id: 'envelope-navy-back', file: 'navy-elements/envelope-navy-back.webp', name: 'Phong bì navy mặt sau', tags: ['envelope', 'navy', 'blue'], usage: ['envelope'] },
            { id: 'envelope-navy-flap', file: 'navy-elements/envelope-navy-flap.webp', name: 'Nắp phong bì navy', tags: ['envelope', 'navy', 'blue', 'flap'], usage: ['envelope'] },
            /* ---- AI-GEN (bổ sung cho bộ navy) ---- */
            { id: 'paper-ivory-plain', file: 'navy-elements/paper-ivory-plain.webp', name: 'Giấy ngà trơn (seamless)', tags: ['paper', 'ivory', 'cream', 'texture', 'seamless', 'ai-gen'], usage: ['page-background'] },
            { id: 'corner-magnolia-navy', file: 'navy-elements/corner-magnolia-navy.webp', name: 'Góc hoa mộc lan navy (màu nước)', tags: ['floral', 'navy', 'blue', 'watercolor', 'corner', 'magnolia', 'ai-gen'], usage: ['corner-deco', 'section-deco'] },
            { id: 'monogram-song-hy-pearl', file: 'navy-elements/monogram-song-hy-pearl.webp', name: 'Monogram Song Hỷ vòng ngọc trai', tags: ['monogram', 'navy', 'song-hy', 'pearl', 'lineart', 'ai-gen'], usage: ['section-divider', 'accent'] },
            /* ---- LOTUS / SEN SET (harvest ziuwedding: sen hồng, vân mây, nón lá, trầu cau) ---- */
            { id: 'seal-lotus-sage', file: 'lotus-elements/seal-lotus-sage.webp', name: 'Dấu sáp hoa sen xanh rêu', tags: ['seal', 'sage', 'green', 'lotus', 'envelope', 'traditional'], usage: ['envelope-seal'] },
            { id: 'cloud-van-may-teal', file: 'lotus-elements/cloud-van-may-teal.webp', name: 'Vân mây Việt xanh ngọc', tags: ['cloud', 'van-may', 'teal', 'traditional', 'vietnamese'], usage: ['corner-deco', 'section-deco'] },
            { id: 'tassel-pink', file: 'lotus-elements/tassel-pink.webp', name: 'Tua rua hồng', tags: ['tassel', 'pink', 'hanging', 'traditional'], usage: ['envelope-decor', 'hanging'] },
            { id: 'ribbon-band-pink', file: 'lotus-elements/ribbon-band-pink.webp', name: 'Dải ruy băng hồng viền vàng', tags: ['ribbon', 'pink', 'gold', 'band'], usage: ['envelope-decor'] },
            { id: 'bg-lotus-watercolor', file: 'lotus-elements/bg-lotus-watercolor.webp', name: 'Nền sen màu nước dọc', tags: ['lotus', 'pink', 'watercolor', 'background', 'soft'], usage: ['page-background', 'card-background'] },
            { id: 'envelope-pink', file: 'lotus-elements/envelope-pink.webp', name: 'Phong bì hồng', tags: ['envelope', 'pink', 'soft'], usage: ['envelope'] },
            { id: 'chibi-couple-aodai', file: 'lotus-elements/chibi-couple-aodai.webp', name: 'Chibi cô dâu chú rể áo dài bên sen', tags: ['chibi', 'couple', 'aodai', 'lotus', 'cute', 'vietnamese'], usage: ['decor', 'couple-section'] },
            { id: 'non-la-ribbon', file: 'lotus-elements/non-la-ribbon.webp', name: 'Nón lá thắt nơ đỏ', tags: ['non-la', 'hat', 'vietnamese', 'traditional', 'red'], usage: ['decor', 'section-deco'] },
            { id: 'pouch-lotus-pink', file: 'lotus-elements/pouch-lotus-pink.webp', name: 'Túi quà gấm hồng thêu sen', tags: ['gift', 'pouch', 'pink', 'lotus', 'traditional'], usage: ['gift-section'] },
            { id: 'lotus-leaf', file: 'lotus-elements/lotus-leaf.webp', name: 'Lá sen xanh', tags: ['lotus', 'leaf', 'green', 'botanical'], usage: ['decor', 'corner-deco'] },
            { id: 'lotus-flowers-pink', file: 'lotus-elements/lotus-flowers-pink.webp', name: 'Cụm hoa sen hồng', tags: ['lotus', 'pink', 'flower', 'watercolor'], usage: ['decor', 'corner-deco'] },
            { id: 'trau-tem-canh-phuong', file: 'lotus-elements/trau-tem-canh-phuong.webp', name: 'Trầu têm cánh phượng khay son', tags: ['trau-cau', 'traditional', 'vietnamese', 'red', 'wedding-rite'], usage: ['decor', 'ceremony'] },
            { id: 'petals-falling-pink', file: 'lotus-elements/petals-falling-pink.webp', name: 'Cánh sen rơi hồng', tags: ['petal', 'pink', 'falling', 'lotus'], usage: ['scatter-deco', 'effect'] },
            { id: 'lace-doily-frame', file: 'lotus-elements/lace-doily-frame.webp', name: 'Khung ren trắng', tags: ['lace', 'white', 'frame', 'doily', 'vintage'], usage: ['photo-frame', 'card-background'] },
            { id: 'envelope-pink-open', file: 'lotus-elements/envelope-pink-open.webp', name: 'Phong bì hồng mở lót sen', tags: ['envelope', 'pink', 'lotus', 'open'], usage: ['envelope', 'countdown-frame'] },
            { id: 'lotus-leaf-boat', file: 'lotus-elements/lotus-leaf-boat.webp', name: 'Thuyền lá sen sơn thuỷ', tags: ['lotus', 'leaf', 'landscape', 'art', 'vietnamese'], usage: ['decor', 'accent'] },
            { id: 'bg-lotus-emboss', file: 'lotus-elements/bg-lotus-emboss.webp', name: 'Nền sen dập nổi', tags: ['lotus', 'emboss', 'background', 'texture', 'soft'], usage: ['page-background'] },
            { id: 'envelope-pink-flap', file: 'lotus-elements/envelope-pink-flap.webp', name: 'Nắp phong bì hồng', tags: ['envelope', 'pink', 'flap'], usage: ['envelope'] },
            /* ---- AI-GEN (bổ sung cho bộ sen) ---- */
            { id: 'divider-lotus-line', file: 'lotus-elements/divider-lotus-line.webp', name: 'Phân cách sen line art hồng-rêu', tags: ['divider', 'lotus', 'pink', 'sage', 'lineart', 'ai-gen'], usage: ['section-divider'] },
            { id: 'medallion-lotus-pair', file: 'lotus-elements/medallion-lotus-pair.webp', name: 'Huy hiệu đôi sen trong vòng tròn', tags: ['medallion', 'lotus', 'pink', 'sage', 'lineart', 'monogram', 'ai-gen'], usage: ['section-divider', 'accent', 'between-names'] },
            /* ---- BLUSH / MÂY HỒNG SET (harvest ziuwedding mauhong: chibi, mây hồng, tim) ---- */
            { id: 'heart-red-solid', file: 'blush-elements/heart-red-solid.webp', name: 'Trái tim đỏ đặc', tags: ['heart', 'red', 'solid', 'icon'], usage: ['accent', 'inline-icon'] },
            { id: 'chibi-couple-wedding', file: 'blush-elements/chibi-couple-wedding.webp', name: 'Chibi cô dâu chú rể cưới', tags: ['chibi', 'couple', 'cute', 'wedding'], usage: ['decor', 'couple-section'] },
            { id: 'cloud-pink-small', file: 'blush-elements/cloud-pink-small.webp', name: 'Mây hồng nhỏ', tags: ['cloud', 'pink', 'soft', 'watercolor'], usage: ['scatter-deco', 'corner-deco'] },
            { id: 'corner-pink-blossom', file: 'blush-elements/corner-pink-blossom.webp', name: 'Góc hoa hồng phấn', tags: ['corner', 'pink', 'blossom', 'soft'], usage: ['corner-deco'] },
            { id: 'cloud-pink-wash', file: 'blush-elements/cloud-pink-wash.webp', name: 'Mây hồng loang lớn', tags: ['cloud', 'pink', 'watercolor', 'wash', 'background'], usage: ['edge-deco', 'background'] },
            { id: 'chibi-groom-blush', file: 'blush-elements/chibi-groom-blush.webp', name: 'Chibi chú rể ôm hoa', tags: ['chibi', 'groom', 'cute', 'pink'], usage: ['decor', 'couple-section'] },
            { id: 'chibi-bride-blush', file: 'blush-elements/chibi-bride-blush.webp', name: 'Chibi cô dâu ôm hoa', tags: ['chibi', 'bride', 'cute', 'pink'], usage: ['decor', 'couple-section'] },
            { id: 'divider-blossom-blush', file: 'blush-elements/divider-blossom-blush.webp', name: 'Phân cách hoa anh đào hồng', tags: ['divider', 'pink', 'blossom', 'heart', 'lineart', 'ai-gen'], usage: ['section-divider'] },
            /* ---- MONO / CỔ ĐIỂN SET (harvest ziuwedding tuanhien) ---- */
            { id: 'chibi-couple-tux', file: 'mono-elements/chibi-couple-tux.webp', name: 'Chibi chú rể vest đen & cô dâu voan', tags: ['chibi', 'couple', 'tux', 'classic', 'cute'], usage: ['decor', 'hero-deco'] },
            { id: 'tulip-pink', file: 'mono-elements/tulip-pink.webp', name: 'Hoa tulip hồng', tags: ['floral', 'tulip', 'pink', 'single'], usage: ['inline-icon', 'scatter-deco'] },
            { id: 'wreath-floral-pastel', file: 'mono-elements/wreath-floral-pastel.webp', name: 'Vòng hoa pastel', tags: ['wreath', 'floral', 'pastel', 'circle', 'frame'], usage: ['photo-frame', 'section-deco'] },
            /* ---- FRENCH / CỔ ĐIỂN PHÁP SET (cột, rèm, hoa hồng trắng, lư hoa, nến) ---- */
            { id: 'bouquet-white-roses', file: 'french-elements/bouquet-white-roses.webp', name: 'Bó hoa hồng trắng lớn', tags: ['floral', 'white', 'rose', 'bouquet', 'watercolor'], usage: ['decor', 'corner-deco'] },
            { id: 'candles-cluster', file: 'french-elements/candles-cluster.webp', name: 'Cụm nến cốc thuỷ tinh', tags: ['candle', 'white', 'cluster', 'watercolor'], usage: ['decor', 'section-deco'] },
            { id: 'column-left', file: 'french-elements/column-left.webp', name: 'Cột đá cổ điển trái', tags: ['column', 'stone', 'classic', 'arch', 'vertical'], usage: ['side-deco-left', 'arch'] },
            { id: 'column-right', file: 'french-elements/column-right.webp', name: 'Cột đá cổ điển phải', tags: ['column', 'stone', 'classic', 'arch', 'vertical'], usage: ['side-deco-right', 'arch'] },
            { id: 'curtain-center', file: 'french-elements/curtain-center.webp', name: 'Rèm lụa rủ giữa', tags: ['curtain', 'silk', 'drape', 'ivory'], usage: ['top-deco', 'arch'] },
            { id: 'curtain-left', file: 'french-elements/curtain-left.webp', name: 'Rèm lụa trái', tags: ['curtain', 'silk', 'drape', 'ivory', 'vertical'], usage: ['side-deco-left'] },
            { id: 'curtain-right', file: 'french-elements/curtain-right.webp', name: 'Rèm lụa phải', tags: ['curtain', 'silk', 'drape', 'ivory', 'vertical'], usage: ['side-deco-right'] },
            { id: 'cypress-trees', file: 'french-elements/cypress-trees.webp', name: 'Hàng cây bách', tags: ['tree', 'cypress', 'green', 'landscape'], usage: ['background-deco'] },
            { id: 'flower-stand', file: 'french-elements/flower-stand.webp', name: 'Trụ hoa đứng', tags: ['floral', 'white', 'stand', 'pedestal', 'vertical'], usage: ['side-deco'] },
            { id: 'flower-vase', file: 'french-elements/flower-vase.webp', name: 'Lư hoa trắng', tags: ['floral', 'white', 'vase', 'urn'], usage: ['section-deco'] },
            { id: 'roses-corner-br', file: 'french-elements/roses-corner-br.webp', name: 'Cụm hồng góc dưới phải', tags: ['floral', 'white', 'rose', 'corner'], usage: ['corner-deco'] },
            { id: 'roses-corner-tl', file: 'french-elements/roses-corner-tl.webp', name: 'Cụm hồng góc trên trái', tags: ['floral', 'white', 'rose', 'corner'], usage: ['corner-deco'] },
            { id: 'vase-left', file: 'french-elements/vase-left.webp', name: 'Lư hoa bệ trái', tags: ['floral', 'white', 'vase', 'pedestal', 'vertical'], usage: ['side-deco-left'] },
            { id: 'vase-right', file: 'french-elements/vase-right.webp', name: 'Lư hoa bệ phải', tags: ['floral', 'white', 'vase', 'pedestal', 'vertical'], usage: ['side-deco-right'] },
            { id: 'yacht-illustration', file: 'french-elements/yacht-illustration.webp', name: 'Du thuyền vẽ tay', tags: ['yacht', 'boat', 'illustration', 'sea'], usage: ['event-illustration'] }
        ]
    },
